...
import { deletePostAction } from "@/actions/editorial";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
export function EditorialDeleteButton({ id, title }: { id: string; title: string }) {
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ¿Estás seguro de eliminar <span className="font-medium text-ink">{title}</span>? Esta acción no se puede deshacer.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
